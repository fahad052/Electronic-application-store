...
List<Product> products = [
  ...
  Product(
    ...
    description:
        "سماعات الرأس داخل الأذن، هي سماعات رأس صغيرة ذات قابلية مماثلة لسماعات الأذن التي يتم إدخالها في قناة الأذن نفسها. وهي سماعات رأس داخل الأذن عالية الجودة ويستخدمها مهندسو الصوت والموسيقيون وكذلك عشاق الصوت.",
  ),
  Product(
    id: 5,
    price: 68,
